...
const Navbar: React.FC = () => {
  ...
  const allNavItems = [
    ...
    { to: "/stock", icon: <PackagePlus size={20} />, label: "Inbound", roles: ['admin', 'inbound', 'staff'] },
    { to: "/outbound-stock", icon: <PackageMinus size={20} />, label: "Outbound", roles: ['admin', 'outbound', 'staff'] },
