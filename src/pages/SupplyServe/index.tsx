...
const Stock: React.FC = () => {
  ...
  {/* totalCount removed - using supplyServeTotalCount instead */}
  ...
  {/* fetchTotalCount removed - no longer needed */}
  ...
  const filteredItems = useMemo(() => {
    ...
    return items.filter(item => {
      ...
      return matchesName && matchesBarcodeAsin && matchesStatusFilter;
    }).sort((a, b) => {
      if (sortBy === 'name') {
